...
EngineLoader::EngineLoader() : runtime(nullptr), engine(nullptr), context(nullptr) {
...
bool EngineLoader::loadEngine(const std::string& enginePath){
...
void EngineLoader::preprocess(Mat& image) {
...
void EngineLoader::postprocess(vector<Detection>& output)
{
...
void EngineLoader::draw(Mat& image, const vector<Detection>& output)
{
